...
const removeStudent = (group, name) => {
    let groupExists = false;
...
const getStudentsByName = (group, name) => {
    let groupExists = false;
...
const getStudentByIndex = (group, index) => {
    let groupExists = false;
...
const Academy = {
    ...
    getStudents: getStudentsByName,
    getStudent: getStudentByIndex
}
